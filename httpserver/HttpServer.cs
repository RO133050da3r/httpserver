...
namespace httpserver
{
    public class HttpServer
    {
        ...
        {
            var serverSocket = new TcpListener(8888); // lytter på porten 8888
            ...
            while (true)
            {
               ...
               Task.Run(() => HandleRequest(ns)); // kører en task.
            }
        ...
        {
            var sr = new StreamReader(ns); // læser streams
            var sw = new StreamWriter(ns); // skriver stream
